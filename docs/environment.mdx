...
Usage is simply done by adding variables to your SAM template and accessing the values fetched from SSM like any other environment variable. Please read the Crypteia's [documentation](https://github.com/customink/crypteia) for full details on how to add [IAM Permissions](https://github.com/customink/crypteia#iam-permissions) to read SSM Parameters.
